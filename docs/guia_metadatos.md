...
<colgroup>
  ...
  <tr>
    ...
    (b) ISO 639-2/T (3 letras) es el más recomendado.<br/>
    Puede definirse uno o más lenguajes en una lista. Los lenguajes especificados para un dataset, sobreesriben a los del catálogo. Si este campo está vacío el dataset hereda los lenguajes del catálogo. (Link a los estándares ISO: https://www.loc.gov/standards/iso639-2/php/code_list.php)
    </td>
    <td>
...
<colgroup>
  ...
  <tr>
    ...
    geo_point: ver estructura en https://www.elastic.co/guide/en/elasticsearch/reference/current/geo-point.html.<br/>
    geojson: ver en http://geojson.org/<br/>
